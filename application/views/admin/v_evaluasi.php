...
<head>
  ...
  <title>SEKOLAH ANAK PANAH | Evaluasi</title>
                ...
                <div class="row">
                  <div class="col-md-4">
                   <table class="table table-stripped">
                    ...
                    <tbody>
                      <?php
                      $thn_ajaran = $this->db->select('*')->from('tbl_thn_ajaran')->where('aktifkan', '1')->order_by('id_ta', 'desc')->get()->result_array();
                      $no = 1;
                      foreach ($thn_ajaran as $ta) {
                          // $none = ($ta['aktifkan']==0) ? 'none' : '' ;
                          // $style = ($ta['aktifkan']==0) ? 'btn-danger' : 'btn-primary' ; ?>
                          <tr>
                            <td><?= $no++ ?></td>
                            <td><?= $ta['thn_ajaran'] ?></td>
                            <td><?= $ta['semester'] ?></td>
                            <!-- location.href='<?= site_url('cetak/raport').'/'.$c['siswa_nis'].'/'.str_replace('/', '-', $ta['thn_ajaran']).'/'.$ta['semester'] ?> ' -->
                            <td class="text-center">
                              <a href="<?= site_url('cetak/raport').'/'.$c['siswa_nis'].'/'.str_replace('/', '-', $ta['thn_ajaran']).'/'.$ta['semester'] ?>" id="btn" class="btn btn-primary" target="_blank"><i class="fa fa-fw fa-print"></i>Cetak</a>
                            </td>
                          </tr>
                        <?php } ?>
                      </tbody>
 ...
 <script type="text/javascript">
  // function openNewTab() {
  //   window.open("<?= site_url('cetak/raport').'/'.$c['siswa_nis'].'/'.str_replace('/', '-', $ta['thn_ajaran']).'/'.$ta['semester'] ?>");
  // }
