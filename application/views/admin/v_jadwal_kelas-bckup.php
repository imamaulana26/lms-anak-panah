                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-6">
                                    <form action="<?= base_url('jadwal/add_jadwal_kelas') ?>" method="post">
                                        <h5>Seting Jadwal Kelas</h5>
                                        <?php foreach ($dt_mapel as $dtmapel) {
                                        ...
                                        ?>
                                            ...
                                            <div class="row">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php $no = 1;
                                                        foreach ($mapel as $senin) {

                                                        ?>

                                                            <tr>
                                                                <th scope="row"><?= $no++ ?></th>
                                                                <td><?= $senin['nm_mapel'] ?></td>
                                                                <td><span class="button-checkbox">
                                                                        <button type="button" class="btn" data-color="primary">Video Converence</button>
                                                                        <input type="text" value="<?= $senin['nm_mapel'] ?>" name="data[]">
                                                                        <input type="text" value="<?= $dtmapel['hari'] ?>" name="data[]">
                                                                        <input type="checkbox" name="data[]" value="Vc" class="hidden" <?php
                                                                                                                                            foreach ($dtmapel['data'] as $key1) {
                                                                                                                                                if ($key1['mapel'] === $senin['nm_mapel']) {
                                                                                                                                                    if ($key1['tipe'] === 'Vc') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    }
                                                                                                                                                }
                                                                    ...
                                                                    <span class="button-checkbox">
                                                                        <button type="button" class="btn" data-color="primary">Kelas Komunitas</button>
                                                                        <input type="text" value="<?= $senin['nm_mapel'] ?>" name="data[]">
                                                                        <input type="text" value="<?= $dtmapel['hari'] ?>" name="data[]">
                                                                        <input type="checkbox" name=" data[]" value="Kc" class="hidden" <?php
                                                                                                                                                foreach ($dtmapel['data'] as $key1) {
                                                                                                                                                    if ($key1['mapel'] === $senin['nm_mapel']) {
                                                                                                                                                        if ($key1['tipe'] === 'Kc') {
                                                                                                                                                            echo 'checked';
                                        ...
                                        <div class="row">
                                            <span class="button-checkbox">
                                                ...
                                                <input type="checkbox" class="hidden" name="senin[]" />
                                            </span>
                                            <span class="button-checkbox">
                                                <button type="button" class="btn" data-color="primary">Unchecked</button>
