    ...
    <div class="modal fade" id="modaleditkeuangan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form class="form-horizontal" id="form_keuangan" action="<?php echo base_url().'keuangan/edit_keuangan_submit'?>" method="post" enctype="multipart/form-data">
            <div class="modal-body">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <div class="col-md-4">
                    <input type="text" name="nom_tagihan" id="nom_tagihan" class="form-control" readonly>
                  </div>
                </div>
              </div>
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            for(var i = 0; i < data.length; i++){
              var select = ''; sisa_angsur = data[i].nom_tagihan; sisa_pembayaran = data[i].sisa_angsur;
              html += '<tr>';
              ...
              html += '<td class="row"><div id="only-number"><input type="text" class="form-control col-md-4" id="nom_bayar"  placeholder="Input Angka" ></div></td>';
              html += '<td class="row"><input type="text" class="form-control col-md-4" name="tgl_bayar" id="tgl_bayar" placeholder="yyyy-mm-dd" required></td>';
