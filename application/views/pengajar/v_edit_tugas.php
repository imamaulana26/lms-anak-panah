		...
		<div class="container">
			<div class="row">
				<div class="offset-1 col-sm-10">
					...
					<a href="<?= site_url('tugas/' . $data['id_forum']) ?>" class="btn btn-link float-right">Back to Tugas</a>
...
<script>
	...
	function save_forum() {
		...
		msg = 'Tugas ' + data['judul_materi'] + ' berhasil diubah';
