							...
							<div class="row">
								<div class="col-sm-4">
									<div class="card" style="height: 21%">
										...
										<div class="m-3">
											<p class="card-text"><i class="fas fa-fw fa-bookmark mr-1"></i> Matematika (Kalkulus dan Integral)</p>
											<p class="card-text"><i class="far fa-fw fa-calendar-alt mr-1"></i> <?= date('d M Y'); ?></p>
											<p class="card-text"><i class="far fa-fw fa-clock mr-1"></i> 09:20 - 10:10</p>
										</div>
									</div>
								</div>
								<div class="col-sm-4">
								...
								<!-- <div class="col-sm-4">
									<div class="card border-dark mb-3" style="max-width: 18rem;">
										<a href="#">
											<div class="card-header bg-primary">
												<i class="fas fa-fw fa-video mr-1"></i> Belajar Online <br>(Sedang Berlangsung)
											</div>
										</a>
										<div class="card-body text-dark">
											<p class="card-text"><i class="fas fa-fw fa-bookmark mr-1"></i> Matematika </p>
											<p class="card-text"><i class="far fa-fw fa-calendar-alt mr-1"></i> <?= date('d M Y'); ?></p>
											<p class="card-text"><i class="far fa-fw fa-clock mr-1"></i> 09:20 - 10:10</p>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="card border-dark mb-3" style="max-width: 18rem;">
											...
											<div class="card-header bg-light">
												<i class="fas fa-fw fa-video mr-1"></i> Belajar Online <br>(Belum Dimulai)
											</div>
										
										<div class="card-body text-dark">
											<p class="card-text"><i class="fas fa-fw fa-bookmark mr-1"></i> Bahasa Indonesia</p>
											<p class="card-text"><i class="far fa-fw fa-calendar-alt mr-1"></i> <?= date('d M Y'); ?></p>
											<p class="card-text"><i class="far fa-fw fa-clock mr-1"></i> 10:20 - 11:10</p>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="card border-dark mb-3" style="max-width: 18rem;">
										...
										<div class="card-body text-dark">
											<p class="card-text"><i class="fas fa-fw fa-bookmark mr-1"></i> Bahasa Inggris</p>
											<p class="card-text"><i class="far fa-fw fa-calendar-alt mr-1"></i> <?= date('d M Y'); ?></p>
											<p class="card-text"><i class="far fa-fw fa-clock mr-1"></i> 11:20 - 12:10</p>
										</div>
									</div>
								</div>
